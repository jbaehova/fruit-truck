...
description: Add story-driven short-form video expertise to an OpenGen UI Agent production, including beats, continuity sheets, keyframes, short shot generation, and final crop/merge. Use with open-gen-ui-agent for reels, shorts, social films, micro-narratives, or any multi-shot video whose story must land in a brief total duration.
---

# Story-driven Short-form

Compose this Workflow Skill with `open-gen-ui-agent`; follow the Core Skill for state, model choice, approvals, safety, lineage, and execution.
