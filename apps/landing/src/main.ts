...
const copy: Record<Locale, Copy> = {
  en: {
    ...
    downloadMac: "DOWNLOAD FOR MAC", downloadMeta: "Apple Silicon · Beta",
    ...
    installTitle: "HOW TO INSTALL.", installBody: "Fruit Truck is signed and notarized by Apple, so it opens normally after installation.",
    installOne: "Open the DMG and drag Fruit Truck to Applications.", installTwo: "Open Fruit Truck from Applications.",
  ...
  ko: {
    ...
    downloadMac: "MAC용 다운로드", downloadMeta: "Apple Silicon · 베타",
    ...
    installTitle: "설치 방법", installBody: "Fruit Truck은 Apple 서명과 공증을 받아 설치 후 바로 실행할 수 있습니다.",
    installOne: "DMG를 열고 Fruit Truck을 Applications로 드래그합니다.", installTwo: "Applications에서 Fruit Truck을 엽니다.",
