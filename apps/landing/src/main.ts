...
const copy: Record<Locale, Copy> = {
  en: {
    ...
    installTitle: "HOW TO INSTALL.", installBody: "OpenGen UI is distributed without Apple notarization. macOS will ask you to approve it once.",
    ...
    updateLabel: "IN-APP UPDATES FROM 0.2.0", updateTitle: "UPDATE IN APP. KEEP YOUR KEY.", updateBody: "Install 0.2.0 once, then OpenGen UI checks for signed updates whenever it starts.",
    ...
    updatePersistence: "Your API key stays in ~/.open-gen-ui, outside the app bundle, so updating does not remove it.", downloadLatest: "DOWNLOAD THE LATEST DMG",
  ...
  ko: {
    ...
    installTitle: "설치 방법", installBody: "OpenGen UI는 Apple 공증 없이 배포됩니다. macOS에서 최초 한 번만 허용하면 됩니다.",
    ...
    updatePersistence: "API 키는 앱 밖 ~/.open-gen-ui에 저장되므로 업데이트해도 유지됩니다.", downloadLatest: "최신 DMG 다운로드",
